...
link="trojan-go://${user}@${bug}:${trgo}/?sni=${domain}&type=ws&host=${domain}&path=/Jvg&encryption=none#$user"
link1="trojan://${user}@${bug}:8443/?sni=${domain}&type=ws&host=${domain}&path=/Jvg&encryption=none#$user"
link2="trojan://${user}@${bug}:8880/?sni=&type=ws&host=${domain}&path=/Jvg&encryption=none#$user"
clear
echo -e ""
echo -e "════════════════" | lolcat
